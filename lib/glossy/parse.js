...
var signedBlockValues = {
  // Section 4.2.1
  hashAlgorithm: [null, 'SHA1', 'SHA256'],
    ...
    if (segments[0] !== '-') {
      ...
      if (spliceMarker !== 0) {
        ...
        if (parsedMessage.structuredData.ssign) {
          parsedMessage.structuredData.signedBlock = this.parseSignedBlock(
            parsedMessage.structuredData
          );
...
GlossyParser.prototype.parseSignedBlock = function (block) {
  ...
  if (versionMatch !== null) {
    ...
    validatedBlock.hashAlgoString =
      signedBlockValues.hashAlgorithm[validatedBlock.hashAlgorithm];
...
GlossyParser.prototype.parseSignedCertificate = function (block) {
  ...
  validatedBlock.payloadName =
    signedBlockValues.keyBlobType[payloadFragment[1]];
