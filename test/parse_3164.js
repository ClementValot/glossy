...
syslogParser.parse(withDifficultTime, function (parsedMessage) {
  var expectedData = {
    ...
    time: undefined,
    message:
      '51w2d: DHCPD: assigned IP address 10.10.1.94 to client 0100.01c4.21d3.b3'
  };
...
syslogParser.parse(withYear, function (parsedMessage) {
  var expectedData = {
    ...
    host: '22:21:02:',
    message:
      '%ASA-6-302013: Built inbound TCP connection 401 for outside:123.123.123.123/4413 (123.123.123.123/4413) to net:BOX/25 (BOX/25)'
  };
